...
import { ChevronsUpDown, Check, Plus, Building2, Clock, Layers } from 'lucide-react';
    ...
    <>
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button className="flex h-8 items-center gap-1.5 rounded-md border border-line bg-white px-2.5 text-[13px] font-medium text-foreground transition-colors hover:border-line-2 hover:bg-surface-2">
            <Layers className="h-3.5 w-3.5 text-primary" />
            <span className="max-w-[140px] truncate">{activeWorkspace?.orgName || '选择工作台'}</span>
